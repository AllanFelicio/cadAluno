	...
	<body>
		...
		<form action="usucontroller.do" method="post">
			...
			<fieldset>
				<label>
					<span>Usúario: </span>
					<input id="usuario" type="text" name="usuario" placeholder="Até 10 Caracteres" maxlength="10" required >
				</label>
				<label>
					<span>Nome: </span>
				...
				<label>
					<span>Senha: </span>
					<input type="password" name="senha" minlength='8' maxlength='15' placeholder='Até 8 Digitos' required>
				</label>
				<label>
